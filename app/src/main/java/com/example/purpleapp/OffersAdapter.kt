...
class OffersAdapter(val data: MutableList<ViewAllProductsData>):Adapter<OffersViewHolder>()
{
...
//        holder.discount.text = item.disc
        ...
        holder.openProd.setOnClickListener {
            it.findNavController().navigate(OffersFragmentDirections.actionOffersFragmentToProductDescriptionFragment(item.id))
